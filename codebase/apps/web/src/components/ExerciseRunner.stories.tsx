...
const alone = { id: 'story-session', startedAt: Date.now(), plannedSeconds: null, step: 1, total: 1, onContinue: fn() }
...
export const MidSession: Story = {
  // Planned to twenty minutes, four minutes in: the header carries the run's own clock.
  args: { session: { ...alone, step: 2, total: 4, startedAt: Date.now() - 4 * 60_000, plannedSeconds: 20 * 60 } },
