...
const meta = { title: 'Components/PracticeRunner', component: PracticeRunner,
  ...
  parameters: { docs: { description: { component: 'The lesson player: the exercise as a tab, click at tempo with a cursor on the current note, timer or pass counter, self-grade, summary. Session callbacks are local Storybook actions; the click plays through Web Audio once Begin is pressed.' } } },
