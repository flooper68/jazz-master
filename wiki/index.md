...
Map of all wiki pages — read this first, then open only what the question needs. Conventions: `README.md`; operations: `processes/wiki-maintenance.md`.

## Product — how the product works

- [product/overview.md](product/overview.md) — what Jazz Master is, the zero-tension practice flow it promises, its module pillars, and what is built versus pending today.
- [product/theory-engine.md](product/theory-engine.md) — the domain core: why enharmonic spelling is the point, transpose-moves-the-letter correctness, chords/scales as data, and how chromatic frets get key-aware labels.
