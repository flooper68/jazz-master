...
6. **Feed forward.** The consuming task turns Recommendations into concrete changes (process docs, CLAUDE.md conventions, code). Link the RES id from the task's frontmatter (`research: RES-###`) and Log.
