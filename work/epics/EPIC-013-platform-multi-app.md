...
- Persistence transition planning: ADR-012 will supersede ADR-002's local-first target after NOTE-013 and owner discussion on 2026-07-09; Clerk is the chosen identity provider, Clerk user IDs key app data, and existing local data will not be migrated (TASK-062)
