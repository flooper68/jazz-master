...
- Local database foundation: Postgres via Docker Compose + `psql`, Drizzle ORM, generated SQL migrations, and a server-only DB smoke check (TASK-028, TASK-055, TASK-056; RES-017)
