...
- Clerk/Postgres feature migration: Clerk auth foundation, Clerk-keyed user anchor, profile/onboarding, sessions/grades/scores, server-computed daily plans, preferences, backup/import removal, localStorage layer removal, and a final regression pass (TASK-063, TASK-065 through TASK-072)
