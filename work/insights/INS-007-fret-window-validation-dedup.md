...
2026-07-06 (heartbeat) — Deferred. Behavior is identical today and no third
window-taking function exists yet; the drift risk becomes real when CAGED/3NPS
position layers add more of them. Revisit then — the extraction is a natural
rider on whichever task adds the next window-taking function, not standalone
work now.
